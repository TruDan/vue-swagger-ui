      ...
      <v-col sm="12" lg="6">
        <v-card>
          ...
          <v-simple-table v-if="operation.parameters">
            ...
            <tr v-for="parameter of operation.parameters" :key="parameter.name">
              <td>
              ...
              <td>
                <v-switch readonly :value="parameter.required" />
              </td>
            </tr>
          </v-simple-table>
        </v-card>
            ...
            >
              ...
              <v-expansion-panel-content v-if="response.content">
                <v-tabs v-model="responseTab">
                  <v-tab
                    v-for="[responseType] of Object.entries(response.content)"
                    :key="responseType"
                  >
                    {{ responseType }}
                  </v-tab>
                ...
                <v-tabs-items v-model="responseTab">
                  <v-tab-item
                    v-for="[responseType, responseContent] of Object.entries(
                      response.content
                    )"
                    :key="responseType"
                  >
